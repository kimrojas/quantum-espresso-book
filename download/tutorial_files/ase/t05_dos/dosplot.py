...
line = subprocess.check_output("grep 'Fermi energy' ./run_files/espresso_scf.pwo", shell=True)
...
def get_data(fname):
    en, dos = np.genfromtxt('./run_files/'+fname, skip_header=1, usecols=(0,1), unpack=True)
