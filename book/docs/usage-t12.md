...
A GOFEE calculation of `Ti5O10` with DFTB+ as a fast and relatively accurate evaluator. Here we use a parallelized GOFEE implementation and a **Non-parallelized** DFTB+ calculation (Parallelization mixing will be discussed in the future).
